      ...
      <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
        <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
          <h1 className="title-font font-medium text-3xl text-gray-900">
            Enhance Email Security and Brand Reputation with Our Authentic Mail
            Solutions.
          </h1>
          <p className="leading-relaxed mt-4">
            We offer robust email verification services that ensure By verifying
            the authenticity of the sender&apos;s identity, we help prevent
            unauthorized access to your inbox and protect your sensitive
            information
          </p>
        </div>
